...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'The best Signature Pad gem you will ever find!'
  spec.description   = 'This Gem gives you access to a signature pad form helper so you can save touchpad signatures as encoded png data'
